...
export const Bold: ComponentStory<typeof CheckBox> = () => (
  <CheckBox
...
export const Checked: ComponentStory<typeof CheckBox> = () => (
  <CheckBox text='[필수] 만 14세 이상입니다' checked={true}></CheckBox>
);
...
export const CheckBoxGroup: ComponentStory<typeof CheckBox> = () => (
  <CheckBox checked={false} description text='[선택] 광고성 정보 수신 동의'>
    <CheckBox checked={false} text='[선택] 이메일 수신 동의' />
    <CheckBox checked={false} text='[선택] SMS,MMS 수신 동의' />
    <CheckBox checked={false} text='[선택] 앱 푸시 수신 동의' />
  </CheckBox>
);
